...
def process_images(folder_path, exclude_colors, num_colors=5):
    ...
    return top_colors_list, top_silhouettes_list, top_accessories_list

# Function to write results to a text file
def write_results_to_file(folder_path, top_colors, top_silhouettes, top_accessories):
    # Extract folder name from the folder path
    folder_name = os.path.basename(folder_path)

    # Construct the file name
    file_name = os.path.join(os.getcwd(), folder_name + ".txt")

    # Write the results to the text file
    with open(file_name, "w") as file:
        file.write("Top colors:\n")
...
top_colors, top_silhouettes, top_accessories = process_images(folder_path, exclude_colors)

# Print or use the results as needed
print("Top colors:", top_colors)
print("Top silhouettes:", top_silhouettes)
print("Top accessories:", top_accessories)

# Write the results to a text file
write_results_to_file(folder_path, top_colors, top_silhouettes, top_accessories)